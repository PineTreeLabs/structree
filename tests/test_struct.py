...
# This test file combines code from pybaum (MIT, (c) 2022 Janos Gabler,
# Tobias Raabe), JAX (Apache-2.0, (c) 2021 The JAX Authors), and new code
# that is (c) 2025-2026 Pine Tree Labs, LLC under the MIT License.
